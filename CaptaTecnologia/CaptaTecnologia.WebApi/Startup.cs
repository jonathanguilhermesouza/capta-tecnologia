...
namespace CaptaTecnologia.WebApi
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<CaptaTecnologiaContext>(options =>
               options.UseSqlServer(
                   Configuration.GetConnectionString("CaptaTecnologiaContext")));
            ...
            //services.AddScoped<BaseRepository<Candidate>, CandidateRepository>();
